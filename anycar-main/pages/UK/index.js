        ...
        <div>
          ...
          <main className={styles.main}>
              ...
              <div className="container" uk-scrollspy="target: .uk-scrollspy-class; cls: uk-animation-slide-bottom-medium; delay: 100;">
                <div className={styles.top__left}>
                  ...
                  <div className={`uk-scrollspy-class ${styles.top__left_bottom}`}>
                    <Button text="Залишити заявку" onClick={() => setOpen(true)} />
            ...
            <section className={styles.info}>
              <Info data={page.post_custom.SEO_text_home} />
            </section>
          ...
          <Footer lang={lang} />
          <Modal open={open} setOpen={setOpen} title="Залиште заявку" name={true} phone={true} lang={lang}/>
        </div>
      }
