            ...
            <section className={styles.policy}>
              <div className="container">
                <div className={styles.policy__toggle}>
                  <li className={active === "policy" ? styles.active : ''} onClick={() => setActive("policy")}>Політика конфіденційності</li>
                  <li className={active === "agreement" ? styles.active : ''} onClick={() => setActive("agreement")}>Угода користувача</li>
                </div>
