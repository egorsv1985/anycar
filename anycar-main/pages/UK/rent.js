                  ...
                  <div className={styles.calc__left}>
                    ...
                    <ul className={styles.calc__left_bottom}>
                      <li>
                        ...
                        Чистий прибуток партнера в місяць (грн)
                      </li>
                      <li>
                        <span>{(auto * 7500).toLocaleString()}</span>
                        Середній пробіг в міс (км)
                      </li>
                    </ul>
                  </div>
