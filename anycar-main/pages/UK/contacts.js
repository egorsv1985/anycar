...
export default function Contacts() {
  ...
  const validate = values => {
    ...
    if (!values.name.trim()) {
      errors.name = 'Заповніть це поле';
    }

    if (!values.email.trim()) {
      errors.email = 'Заповніть це поле';
                ...
                <div className={styles.contacts__right}>
                  ...
                  <FormikProvider value={formik}>
                    ...
                    <label>
                      ...
                      <Button text="Відправити" disabled={disabledBtn}/>
                    </form>
                  </FormikProvider>
