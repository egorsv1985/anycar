                ...
                <div className={styles.calc} uk-scrollspy="cls: uk-animation-fade">
                  ...
                  <div className={styles.calc__right}>
                    <ul className={styles.calc__right_top}>
                      <li>
                        <span>
                          {Math.round((autoPrice - firstPayment) / term)} $ / 
                          {Math.round(Math.round((autoPrice - firstPayment) / term) * usd).toLocaleString()} грн
                        </span>
                        сумма еженедельного платежа
                      </li>
                    </ul>
